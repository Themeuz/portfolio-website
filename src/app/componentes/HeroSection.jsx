    ...
    <section>
        <div className="grid grid-cols-1 sm:grid-cols-12">
            <div className="col-span-7 place-self-center text-center sm:text-left">
                <h1 className='text-[#025a4e] mb-4 text-9xl font-extralight sm:text-5xl'>Oi, me chamo <strong className=' mb-4 text-7xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-[#025a4e] to-[#5f734f]'>Matheus Bicego</strong></h1>
                ...
                <div>
                  ...
                  <button className='px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-bl from-[#508b7b] to-[#bcbe34] hover:border text-slate-800'>Contato</button>
                  </a>
                  <a href="https://drive.google.com/file/d/1wrR6N0s6-Mw5Cj21E2h7iyrW9MhNbBiC/view">
                  <button href="##LINKACESSO" className='px-6 py-3 w-full sm:w-fit rounded-full bg-transparent hover:bg-state-800 text-[#025a4e] border hover:border-green-900 mt-3'>Currículo</button>
                  </a>
                </div>
            </div>
